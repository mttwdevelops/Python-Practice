...
I also went to a data science talk today, which was mainly for networking and just curiosity. I did learn about resources like [Datakind](datakind.org) and [all tech is human](alltechishuman.org), which I'll take a longer look at when I have more experience, and it's probably not good to stretch myself out too thin looking too long at everything when I should be focusing on a few things for now. 
